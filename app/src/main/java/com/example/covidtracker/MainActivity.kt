...
class MainActivity : AppCompatActivity() {
    ...
    private fun getStateInfo(){
        ...
        val request = JsonObjectRequest(Request.Method.GET, url, null,{ responce->
          try {
              val dataObj = responce.getJSONObject("data");
    ...
    private fun getWorldInfo(){
        ...
        val request = JsonObjectRequest(Request.Method.GET, url, null, { responce ->
            try {
                val worldCases:Int = responce.getInt("cases")
                val worldRecovered:Int = responce.getInt("recovered")
                val worldDeaths:Int = responce.getInt("deaths")

                worldCasesTV.text = worldRecovered.toString()
